...
import {
  ...
  LogOut, Building2, CalendarDays, Cpu, Terminal, HelpCircle,
} from 'lucide-react'
      ...
      <header className="bg-white border-b border-slate-200 px-8 py-4 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="ml-2 text-sm text-slate-400">On-Prem 安裝包下載</span>
          </div>
        </div>
        {result && (
          <button
            onClick={handleReset}
            className="flex items-center gap-1.5 rounded-lg border border-slate-200 px-3 py-1.5 text-sm text-slate-500 hover:bg-slate-50 hover:text-slate-800 transition-colors"
          >
        ...
        {!result ? (
          ...
          <div className="w-full max-w-md">
            <div className="mb-8 text-center">
              ...
              <p className="mt-1.5 text-sm text-slate-500">請貼入 REAS 提供的 Activation Code 以存取下載頁面</p>
            </div>
              ...
              <form onSubmit={(e) => { void handleVerify(e) }} className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="eyJ..."
                    rows={4}
                    className="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 font-mono text-xs text-slate-800 placeholder-slate-300 focus:border-blue-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-100 resize-none transition-colors"
                  />
                </div>
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-3 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 active:bg-blue-800 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                >
          ...
          <div className="w-full max-w-6xl">
            ...
            <div className="mb-6 flex items-center gap-3 rounded-xl bg-emerald-50 px-5 py-3.5 ring-1 ring-emerald-200">
              ...
              <span className="text-sm font-medium text-emerald-800">授權驗證成功，以下為您的授權資訊與可下載版本</span>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-5">
              ...
              <div className="lg:col-span-2 space-y-5">
                ...
                <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {result.agents.map(a => (
                      <span
                        key={a}
                        className="rounded-lg bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-700 ring-1 ring-blue-100"
                      >
                        {a}
                      </span>
                    ))}
                ...
                <div className="rounded-2xl bg-slate-900 p-6 shadow-sm">
                  ...
                  <pre className="overflow-x-auto text-xs leading-relaxed text-slate-300">{`tar xzf neurosme-onprem-vX.X.X.tar.gz
...
docker compose \\
  -f docker-compose.onprem.yml up -d`}</pre>
                </div>
              ...
              <div className="lg:col-span-3">
                <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 h-full">
                  <h2 className="mb-5 flex items-center justify-between">
                    <span className="flex items-center gap-2 text-sm font-semibold uppercase tracking-wide text-slate-400">
                  ...
                  {result.releases.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-16 text-center">
                      ...
                      <p className="text-sm font-medium text-slate-600">目前尚無可下載的版本</p>
                      <p className="mt-1 text-xs text-slate-400">請聯絡 REAS 技術支援</p>
                    </div>
                  ) : (
                    <div className="space-y-3">
                          ...
                          >
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <p className="mt-0.5 text-xs text-slate-400">{r.size_mb} MB</p>
                              </div>
                            </div>
